    ...
    public ControladorFamilias(frmFamilia vista, ClienteFamiliaArreglo modelo){
        ...
        this.vista.btnGuardarFamilia.addActionListener( new ActionListener() {
                public void actionPerformed(ActionEvent e)
                    ...
                    ClienteFamilia f = new ClienteFamilia(vista.txtNroIntegrantes.getText(), vista.txtNroMascotas.getText(), vista.txtApellido.getText(),vista.txtCtaB.getText(),vista.txtDireccion.getText(),vista.txtCel.getText());
